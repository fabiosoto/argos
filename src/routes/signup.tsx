    ...
    <div className="min-h-screen bg-zinc-950 flex items-center justify-center p-4">
      <div className="w-full max-w-md">
        <div className="text-center mb-8">
          ...
          <p className="text-sm text-zinc-500 mt-1">Acesse o Argos ERP Dashboard</p>
        </div>
        <form onSubmit={handleSubmit} className="bg-zinc-900/60 border border-zinc-800/60 rounded-2xl p-6 space-y-4">
          ...
          <p className="text-center text-xs text-zinc-500">
            Já tem conta?{" "}
            <a href="/signin" className="text-blue-400 hover:text-blue-300 transition-colors">Entrar</a>
          </p>
        </form>
      </div>
    </div>
